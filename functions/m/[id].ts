...
function notFoundPage(): Response {
  return html(`<!DOCTYPE html><html lang="pt-BR"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Sonara Music</title>
...
export const onRequest: PagesFunction<Env> = async (context) => {
  ...
  const downloadName  = `sonara-${esc(para).toLowerCase().replace(/\s+/g,'-')}.mp3`;
...
<meta property="og:description" content="Presente musical de ${esc(buyerName)} — Sonara Music">
<title>${esc(songTitle)} — Sonara Music</title>
<style>
...
<div class="wrap">
  ...
  <div class="bump-card">
    ...
    <div class="bump-body">
      <div class="qr-wrap">
        ...
        <a class="dl-btn" href="${qrCodeUrl}" download="qrcode-${esc(para).toLowerCase().replace(/\s+/g,'-')}-sonara.png" style="font-size:15px;padding:14px">⬇ Baixar QR Code</a>
      </div>
    </div>
  </div>` : ''}
  ...
  <div class="footer">Criado com ❤️ por <a href="/">Sonara Music</a></div>
</div>
